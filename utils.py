...
SOL_WALLET1_ADDRESS = os.environ.get("SOL_WALLET1_ADDRESS", "")
SOL_WALLET2_ADDRESS = os.environ.get("SOL_WALLET2_ADDRESS", "")
...
if not SOL_WALLET1_ADDRESS or not SOL_WALLET2_ADDRESS:
    logger.critical("CRITICAL ERROR: SOL_WALLET1_ADDRESS and SOL_WALLET2_ADDRESS must be configured.")
    raise SystemExit("Solana wallets not configured.")

if not SOL_MIDDLEMAN_ADDRESS or not SOL_MIDDLEMAN_PRIVATE_KEY:
    logger.critical("CRITICAL ERROR: SOL_MIDDLEMAN_ADDRESS and SOL_MIDDLEMAN_PRIVATE_KEY must be configured.")
    raise SystemExit("Solana middleman wallet not configured.")

# Validate wallet addresses (basic length check)
if len(SOL_WALLET1_ADDRESS) < 32 or len(SOL_WALLET2_ADDRESS) < 32 or len(SOL_MIDDLEMAN_ADDRESS) < 32:
    logger.critical("CRITICAL ERROR: Solana wallet addresses appear invalid (too short).")
    raise SystemExit("Invalid Solana wallet addresses.")

logger.info(f"✅ Solana Wallet 1: {SOL_WALLET1_ADDRESS[:8]}...{SOL_WALLET1_ADDRESS[-4:]}")
logger.info(f"✅ Solana Wallet 2: {SOL_WALLET2_ADDRESS[:8]}...{SOL_WALLET2_ADDRESS[-4:]}")
logger.info(f"✅ Solana Middleman: {SOL_MIDDLEMAN_ADDRESS[:8]}...{SOL_MIDDLEMAN_ADDRESS[-4:]}")
logger.info(f"🔍 Payment check interval: {SOL_CHECK_INTERVAL} seconds")
if SOLSCAN_API_KEY:
    logger.info("✅ Solscan API key configured")
else:
    logger.warning("⚠️ Solscan API key not configured - using public API (rate limited)")

if not WEBHOOK_URL: 
    logger.warning("WEBHOOK_URL not set. This is okay for SOL payments but needed for webhooks.")
...
LANGUAGES = {
    ...
    "error_discount_mismatch_payment": "❌ Payment amount mismatch detected. Please return to your basket and try again.",
        ...
        "admin_button_sales_analytics": "📊 Sales Analytics",
        "admin_sales_analytics_title": "📊 Sales Analytics\n\nSelect a report or view:",
        "admin_sales_view_dashboard": "📈 View Dashboard",
        "admin_sales_generate_report": "📅 Generate Report",
        "admin_sales_by_city": "🏙️ Sales by City",
        "admin_sales_by_type": "💎 Sales by Type",
        "admin_sales_top_products": "🏆 Top Products",
        "admin_button_recent_purchases": "🔍 Recent Purchases",
        "admin_button_add_products": "➕ Add Products",
        "admin_button_bulk_add": "📦 Bulk Add Products",
        "admin_button_manage_products": "🗑️ Manage Products",
        "admin_button_search_user": "🔍 Search User",
        "admin_button_manage_resellers": "👑 Manage Resellers",
        "admin_button_manage_reseller_discounts": "🏷️ Manage Reseller Discounts",
        "admin_button_manage_discounts": "🏷️ Manage Discount Codes",
        "admin_button_manage_welcome": "👋 Manage Welcome Msg",
        "admin_button_view_stock": "📦 View Bot Stock",
        "admin_button_view_log": "📜 View Added Products Log",
        "admin_button_manage_districts": "🗺️ Manage Districts",
        "admin_button_manage_cities": "🏙️ Manage Cities",
        "admin_button_manage_types": "🧩 Manage Product Types",
        "admin_button_reassign_type": "🔄 Reassign Product Type",
        "admin_button_manage_reviews": "🚫 Manage Reviews",
        "admin_button_clear_reservations": "🧹 Clear ALL Reservations",
        "admin_button_broadcast": "📢 Broadcast Message",
        "admin_button_payment_recovery": "🔧 Manual Payment Recovery",
        "admin_button_bulk_edit_prices": "💰 Bulk Edit Prices",
        "admin_button_add_city": "➕ Add New City",
        "admin_button_set_media": "📸 Set Bot Media",
        "admin_button_home": "🏠 User Home Menu",
        "admin_no_cities": "No cities configured. Please add a city first via 'Manage Cities'.",
        "admin_error_city_not_found": "Error: City not found. Please select again.",
        "admin_no_districts": "No districts found for {city}. Please add districts via 'Manage Districts'.",
        "admin_error_location_not_found": "Error: City/District not found. Please select again.",
    ...
    "lt": {
        ...
        "admin_button_sales_analytics": "📊 Pardavimų Analitika",
        "admin_sales_analytics_title": "📊 Pardavimų Analitika\n\nPasirinkite ataskaitą arba peržiūrą:",
        "admin_sales_view_dashboard": "📈 Peržiūrėti Skydelį",
        "admin_sales_generate_report": "📅 Generuoti Ataskaitą",
        "admin_sales_by_city": "🏙️ Pardavimai pagal Miestą",
        "admin_sales_by_type": "💎 Pardavimai pagal Tipą",
        "admin_sales_top_products": "🏆 Populiariausios Prekės",
        "admin_button_recent_purchases": "🔍 Paskutiniai Pirkimai",
        "admin_button_add_products": "➕ Pridėti Prekes",
        "admin_button_bulk_add": "📦 Masinis Prekių Pridėjimas",
        "admin_button_manage_products": "🗑️ Valdyti Prekes",
        "admin_button_search_user": "🔍 Ieškoti Vartotojo",
        "admin_button_manage_resellers": "👑 Valdyti Perpardavėjus",
        "admin_button_manage_reseller_discounts": "🏷️ Valdyti Perpardavėjų Nuolaidas",
        "admin_button_manage_discounts": "🏷️ Valdyti Nuolaidų Kodus",
        "admin_button_manage_welcome": "👋 Valdyti Pasveikinimo Žinutę",
        "admin_button_view_stock": "📦 Peržiūrėti Boto Atsargas",
        "admin_button_view_log": "📜 Peržiūrėti Pridėtų Prekių Žurnalą",
        "admin_button_manage_districts": "🗺️ Valdyti Rajonus",
        "admin_button_manage_cities": "🏙️ Valdyti Miestus",
        "admin_button_manage_types": "🧩 Valdyti Prekių Tipus",
        "admin_button_reassign_type": "🔄 Perpriskirti Prekės Tipą",
        "admin_button_manage_reviews": "🚫 Valdyti Atsiliepimus",
        "admin_button_clear_reservations": "🧹 Išvalyti VISAS Rezervacijas",
        "admin_button_broadcast": "📢 Siųsti Skelbimą",
        "admin_button_payment_recovery": "🔧 Rankinis Mokėjimo Atkūrimas",
        "admin_button_bulk_edit_prices": "💰 Masinis Kainų Redagavimas",
        "admin_button_add_city": "➕ Pridėti Naują Miestą",
        "admin_button_set_media": "📸 Nustatyti Boto Mediją",
        "admin_button_home": "🏠 Vartotojo Pagrindinis Meniu",
        "admin_no_cities": "Miestų nesukonfigūruota. Pirmiausia pridėkite miestą per 'Valdyti Miestus'.",
        "admin_error_city_not_found": "Klaida: Miestas nerastas. Prašome pasirinkti dar kartą.",
        "admin_no_districts": "Rajonų nerasta {city} mieste. Prašome pridėti rajonus per 'Valdyti Rajonus'.",
        "admin_error_location_not_found": "Klaida: Miestas/Rajonas nerastas. Prašome pasirinkti dar kartą.",
...
MIN_DEPOSIT_EUR = Decimal('5.00') # Minimum deposit amount in EUR (for balance refills)
    ...
    try:
        with get_db_connection() as conn:
            ...
            c.execute('''CREATE TABLE IF NOT EXISTS products (
                ...
                payout_wallet TEXT DEFAULT 'wallet1'
            )''')
            
            # Add payout_wallet column if missing (migration for existing databases)
            try:
                c.execute("ALTER TABLE products ADD COLUMN payout_wallet TEXT DEFAULT 'wallet1'")
                logger.info("Added 'payout_wallet' column to products table.")
            ...
            # <<< ADDED: SOL Payment Tables >>>
            # Pending SOL payments table
            c.execute('''CREATE TABLE IF NOT EXISTS pending_sol_payments (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
            ...
            # SOL forwarding log table (track middleman forwards)
            c.execute('''CREATE TABLE IF NOT EXISTS sol_forwarding_log (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
                payment_id TEXT NOT NULL,
                source_signature TEXT NOT NULL,
                wallet1_amount REAL NOT NULL,
                wallet1_signature TEXT,
                wallet2_amount REAL NOT NULL,
                wallet2_signature TEXT,
